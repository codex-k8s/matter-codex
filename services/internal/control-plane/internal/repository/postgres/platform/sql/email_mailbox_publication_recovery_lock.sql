...
WHERE publication.ref=$1 AND publication.claimant=$2 AND publication.claim_generation=$3
    AND publication.lease_expires_at>clock_timestamp() AND publication.state IN ('PENDING','READY')
