...
func ControlAPIGatewayOperations() map[string]string {
	return map[string]string{
		...
		"platform.command.configuration-writebacks.reject":              controlplanev1.PlatformCommandService_RejectManagedConfigurationGitWriteBack_FullMethodName,
		"platform.command.configuration-writebacks.cancel":              controlplanev1.PlatformCommandService_CancelManagedConfigurationGitWriteBack_FullMethodName,
		"platform.query.configuration-writebacks.get":                   controlplanev1.PlatformQueryService_GetManagedConfigurationGitWriteBack_FullMethodName,
		"platform.query.configuration-writebacks.list":                  controlplanev1.PlatformQueryService_ListManagedConfigurationGitWriteBacks_FullMethodName,
		...
		"platform.query.integration-grant-candidates.connections.list":  controlplanev1.PlatformQueryService_ListIntegrationGrantConnectionCandidates_FullMethodName,
		"platform.query.integration-grant-candidates.projects.list":     controlplanev1.PlatformQueryService_ListIntegrationGrantProjectCandidates_FullMethodName,
		"platform.query.integration-grant-candidates.recipients.list":   controlplanev1.PlatformQueryService_ListIntegrationGrantRecipientCandidates_FullMethodName,
		"platform.query.integration-grant-candidates.capabilities.list": controlplanev1.PlatformQueryService_ListIntegrationGrantCapabilityCandidates_FullMethodName,
		...
		"platform.command.role-image-sources.configure":                 controlplanev1.PlatformCommandService_ConfigureRoleImageGitSource_FullMethodName,
		"platform.command.role-image-sources.refresh":                   controlplanev1.PlatformCommandService_RefreshRoleImageGitSource_FullMethodName,
		"platform.command.integration-definition-sources.configure":     controlplanev1.PlatformCommandService_ConfigureIntegrationDefinitionGitSource_FullMethodName,
		"platform.command.integration-definition-sources.refresh":       controlplanev1.PlatformCommandService_RefreshIntegrationDefinitionGitSource_FullMethodName,
...
func RuntimeOperations() map[string]string {
	return map[string]string{
		...
		"platform.runtime.files.manifest":                     controlplanev1.RuntimeWorkService_GetExecutionFileManifest_FullMethodName,
...
func IntegrationGatewayOperations() map[string]string {
	return map[string]string{
		"platform.configuration-writebacks.work.claim":    controlplanev1.ManagedConfigurationGitWriteBackWorkService_ClaimManagedConfigurationGitWriteBackWork_FullMethodName,
		"platform.configuration-writebacks.work.renew":    controlplanev1.ManagedConfigurationGitWriteBackWorkService_RenewManagedConfigurationGitWriteBackWork_FullMethodName,
		"platform.configuration-writebacks.work.begin":    controlplanev1.ManagedConfigurationGitWriteBackWorkService_BeginManagedConfigurationGitWriteBackEffect_FullMethodName,
		"platform.configuration-writebacks.work.complete": controlplanev1.ManagedConfigurationGitWriteBackWorkService_CompleteManagedConfigurationGitWriteBackEffect_FullMethodName,
		"platform.configuration-writebacks.work.fail":     controlplanev1.ManagedConfigurationGitWriteBackWorkService_FailManagedConfigurationGitWriteBackWork_FullMethodName,
		"platform.configuration-sources.work.claim":       controlplanev1.ManagedConfigurationSourceWorkService_ClaimManagedConfigurationSourceWork_FullMethodName,
		"platform.configuration-sources.work.renew":       controlplanev1.ManagedConfigurationSourceWorkService_RenewManagedConfigurationSourceWork_FullMethodName,
		"platform.configuration-sources.work.complete":    controlplanev1.ManagedConfigurationSourceWorkService_CompleteManagedConfigurationSourceWork_FullMethodName,
		"platform.configuration-sources.work.fail":        controlplanev1.ManagedConfigurationSourceWorkService_FailManagedConfigurationSourceWork_FullMethodName,
